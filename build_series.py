...
# Fixed, even color breaks (3 cutoffs -> 4 bands) scaled to each election type:
# generals span the full turnout range, primaries the much lower one.
GENERAL_BREAKS = [0.40, 0.60, 0.80]
PRIMARY_BREAKS = [0.05, 0.10, 0.15]
